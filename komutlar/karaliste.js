...
exports.run = async (client, message, args) => {
 if(message.author.id !== "679361745248321566") if(message.author.id !== "679361745248321566") return message.channel.send("hoop bilader sahip komutu bu");
  let user = args[0]
  ...
  .setFooter("Eriador")
  .setTimestamp()
  .setDescription(` <@${message.author.id}> adlı yetkilimiz tarafından karalisteye alındın! Artık Eriador'un komutlarını kullanamazsın. Karalisteye alınma sebebin: **${sebep}**`)
